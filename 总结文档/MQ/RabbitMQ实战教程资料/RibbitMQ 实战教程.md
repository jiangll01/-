...
![img](https://img2018.cnblogs.com/blog/575206/201909/575206-20190923150516307-887163413.png)
...
![img](https://img2018.cnblogs.com/blog/575206/201909/575206-20190923150529132-1722121218.png)
...
![img](https://img2018.cnblogs.com/blog/575206/201909/575206-20190923150541354-1432676529.png)

##### 四、查看

进入：http://localhost:15672/#/exchanges

![img](https://img2018.cnblogs.com/blog/575206/201909/575206-20190923150550669-41908962.png)
...
rabbitmq:
    ...
    password: guest
    virtual-host: /
    publisher-returns: false #消息发送后,如果发送失败,则会返回失败信息信息
    publisher-confirm-type: correlated  # 消息发送后,如果发送成功到队列,则会回调成功信息
    listener:
      simple:
        ...
        acknowledge-mode: none #手动应答
        concurrency: 1 #同一个队列启用几个消费者
        max-concurrency: 100 #开启的多线程的最大值
        retry:   # 针对网络原因导致连接断开，利用retryTemplate重连10次
          enabled: true # 开启重试机制
